...
public class DetailsFragment extends Fragment 
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mLayoutImageView = (AnimatingRelativeLayout)rootView.findViewById(R.id.layoutImageView);
		mLayoutImageView.setAnimationCompleteListener(this);
		mLayoutImageView.setVisibility(View.GONE);
		
		mImageView = (TouchImageView)rootView.findViewById(R.id.imagePreView);
		mImageView.setMaxZoom(6);
		mImageCaution = (ImageView)rootView.findViewById(R.id.imageCaution);
		
		mDefinitionView = (DefinitionView)rootView.findViewById(R.id.layoutDefinitionView);
