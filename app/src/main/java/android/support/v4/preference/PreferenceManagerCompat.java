...
public class PreferenceManagerCompat {
	...
	protected static final String TAG = PreferenceManagerCompat.class.getSimpleName();
	...
	/**
	 * Called by the {@link PreferenceManager} to register the activity result listener.
	 */
	public static void registerOnActivityResultListener(PreferenceManager manager, PreferenceManager.OnActivityResultListener listener) {
		try {
			Method m = PreferenceManager.class.getDeclaredMethod("registerOnActivityResultListener",
					PreferenceManager.OnActivityResultListener.class);
			m.setAccessible(true);
			m.invoke(manager, listener);
		} catch (Exception e) {
			Log.w(TAG, "Couldn't call PreferenceManager.registerOnActivityResultListener by reflection", e);
		}
	}

	/**
	 * Called by the {@link PreferenceManager} to unregister the activity result listener.
	 */
	public static void unregisterOnActivityResultListener(PreferenceManager manager, PreferenceManager.OnActivityResultListener listener) {
		try {
			Method m = PreferenceManager.class.getDeclaredMethod("unregisterOnActivityResultListener",
					PreferenceManager.OnActivityResultListener.class);
			m.setAccessible(true);
			m.invoke(manager, listener);
		} catch (Exception e) {
			Log.w(TAG, "Couldn't call PreferenceManager.unregisterOnActivityResultListener by reflection", e);
		}
	}
	...
	/**
	 * Called by the {@link PreferenceManager} to register the activity stop listener.
	 */
	public static void registerOnActivityStopListener(PreferenceManager manager, PreferenceManager.OnActivityStopListener listener) {
		try {
			Method m = PreferenceManager.class.getDeclaredMethod("registerOnActivityStopListener",
					PreferenceManager.OnActivityStopListener.class);
			m.setAccessible(true);
			m.invoke(manager, listener);
		} catch (Exception e) {
			Log.w(TAG, "Couldn't call PreferenceManager.registerOnActivityStopListener by reflection", e);
		}
	}

	/**
	 * Called by the {@link PreferenceManager} to unregister the activity stop listener.
	 */
	public static void unregisterOnActivityStopListener(PreferenceManager manager, PreferenceManager.OnActivityStopListener listener) {
		try {
			Method m = PreferenceManager.class.getDeclaredMethod("unregisterOnActivityStopListener",
					PreferenceManager.OnActivityStopListener.class);
			m.setAccessible(true);
			m.invoke(manager, listener);
		} catch (Exception e) {
			Log.w(TAG, "Couldn't call PreferenceManager.unregisterOnActivityStopListener by reflection", e);
		}
	}
	...
	/**
	 * Called by the {@link PreferenceManager} to register the activity destroy listener.
	 */
	public static void registerOnActivityDestroyListener(PreferenceManager manager,
														 PreferenceManager.OnActivityDestroyListener listener) {
		try {
			Method m = PreferenceManager.class.getDeclaredMethod("registerOnActivityDestroyListener",
					PreferenceManager.OnActivityDestroyListener.class);
			m.setAccessible(true);
			m.invoke(manager, listener);
		} catch (Exception e) {
			Log.w(TAG, "Couldn't call PreferenceManager.registerOnActivityDestroyListener by reflection", e);
		}
	}

	/**
	 * Called by the {@link PreferenceManager} to unregister the activity destroy listener.
	 */
	public static void unregisterOnActivityDestroyListener(PreferenceManager manager, PreferenceManager.OnActivityDestroyListener listener) {
		try {
			Method m = PreferenceManager.class.getDeclaredMethod("unregisterOnActivityDestroyListener",
					PreferenceManager.OnActivityDestroyListener.class);
			m.setAccessible(true);
			m.invoke(manager, listener);
		} catch (Exception e) {
			Log.w(TAG, "Couldn't call PreferenceManager.unregisterOnActivityDestroyListener by reflection", e);
		}
	}
